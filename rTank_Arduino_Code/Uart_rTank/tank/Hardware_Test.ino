void runTests() {
  ...
  driveMotor(0, 0); //Stops the motor
  delay(200);
  driveMotor(200, 1); // Moves the motor forward at 20%
  delay(1000);
  driveMotor(999, 1); // Moves the motor forward at 100%
  delay(1000);
  driveMotor(0, 0); //Stops the motor
  delay(200);
  driveMotor(200, 2); //Move the motor backwards at 20%
  delay(1000);
  driveMotor(999, 2); //Move the motor backwards at 100%
  delay(1000);
  driveMotor(0, 0); //Stops the motor
  delay(200);
